              ...
              <div class="item">
                <div class="card">
                  <div class="card-body">
                    ...
                    <a href="{{ asset('storage/uploads/pdf/PKMC_user.pdf') }}" class="float-right" target="_blank">Read More <i class="fas fa-chevron-right"></i></a>
                  </div>
                </div>
              </div>
              ...
              <div class="item">
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <a href="{{ route('pengumuman-detail', $pengumuman->slug) }}" class="float-right" target="_blank">Read More <i class="fas fa-chevron-right"></i></a>
                  </div>
                </div>
              </div>
            @empty
              ...
              <div class="item">
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <a href="{{ route('beranda-detail', $program->slug) }}" class="float-right" target="_blank">Read More <i class="fas fa-chevron-right"></i></a>
                  </div>
                </div>
              </div>
            @empty
