    ...
    <div class="row justify-content-between">
            ...
            @forelse ($beritas->reverse() as $berita)
              <label for="slide-{{$karyas->count() * ($karyas->currentPage() - 1) + $loop->iteration}}" class="slider__item slider__item--{{$karyas->count() * ($karyas->currentPage() - 1) + $loop->iteration}} card">
                <div class="slider__item-content">
                  <p class="heading-3 heading-3--light">{{ \Carbon\Carbon::parse($berita->tanggal)->translatedFormat('d F Y') }}</p>
      ...
      <div class="col-lg-5 col-md-5 col-12 col-sm-12 event mt-5">
        ...
        @php
          ...
          $bulansShifted = array_merge(array_slice($bulans, $startIndex), array_slice($bulans, 0, $startIndex));
        @endphp
...
<section id="filosofi" class="filosofi">
    <div class="container" data-aos="fade-up">
        ...
        <div class="row d-flex justify-content-center logo-filosofi">
            <div class="col-lg-3">
                <img class="mx-auto logo-home-span" src="{{ url('frontend/assets/img/logo-kabinet/logo-span.png') }}" alt="" width="230">
            </div>
            <div class="col-lg-7 deskripsi">
                <p><strong>KARTALASATYA</strong> yang memiliki arti - didasarkan pada dua kata dalam bahasa sansekerta kartala dan satya. “Kartala” memiliki arti cahaya, mencerminkan komitmen kami untuk mencerahkan pemikiran mahasiswa tentang pentingnya pengembangan intelektual yang kritis dan “Satya” berarti kebenaran, mencerminkan komitmen kami untuk membangun hubungan yang kuat dan saling menguntungkan dengan semua elemen di lingkungan Fasilkom dan pihak eksternal dengan kejujuran dan transparansi. Dalam hal ini, sebuah organisasi BEM Fasilkom Unsika dengan nama kabinet KARTALASATYA.
                </p>
