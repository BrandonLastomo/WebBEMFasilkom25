<!-- Favicons -->
<link href="{{ url('frontend/assets/img/logo-kabinet/logo.png') }}" rel="icon">
<link href="{{ url('frontend/assets/img/logo-kabinet/logo.png') }}" rel="apple-touch-icon">
...
<link href="{{ url('frontend/assets/vendor/owl-carousel/css/owl.carousel.min.css') }}" rel="stylesheet">
<link href="{{ url('frontend/assets/vendor/owl-carousel/css/owl.theme.default.min.css') }}" rel="stylesheet">
<link href="{{ url('frontend/assets/vendor/selectric/public/selectric.css') }}" rel="stylesheet">
...
<!-- JQuery -->
<script src="{{ url('frontend/assets/vendor/jquery/jquery-3.6.0.min.js') }}"></script>

<!-- Main CSS File -->
<link href="{{ url('frontend/assets/css/style.css?v=2.0') }}" rel="stylesheet">
<link rel="stylesheet" href="{{ url('frontend/assets/css/jquery.enjoyhint.css') }}">